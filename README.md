...
When opening the MartianTemp folder there are two jupytner notebook files. Please open the file titled part_1_mars_news to obtain the code for this deliverable. 
